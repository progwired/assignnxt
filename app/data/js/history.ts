export default function jsHistory() {
  return {
    ...
    2. The architects behind Mosaic's success went on to establish Netscape Corporation, giving birth to the iconic Netscape Navigator in 1994 – a polished browser that swiftly claimed the title of the most widely used browser during that time.
